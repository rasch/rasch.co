...
<button type="button" class="green" disabled>Disabled</button>
...
${surveyForm(
  ...
  "radio",
  "question_1",
  ["Vim", "Neovim", "Emacs", "Helix", "Kakoune", "Nano", "Other"],
  "#"
)}

${surveyForm(
  "What are your favorite languages? (check all that apply)",
  "checkbox",
  "question_2",
  ["JavaScript", "Haskell", "Rust", "Zig", "C", "Python", "Go"],
  "#"
)}
